...
fn main() {
    ...
    .insert_resource(ClearColor(Color::rgb(0.9, 0.9, 0.9)));
  {
    ...
    builder
      ...
      .add_system(ScenarioSever::update.system())
      .add_system(move_by_motion.system())
      .add_system(Sora::update.system())
      .add_system_to_stage(CoreStage::PostUpdate, copy_pos_to_transform.system())
      .add_system_to_stage(CoreStage::PostUpdate, handle_lifetime.system())
      .add_system_to_stage(CoreStage::PostUpdate, handle_entity_vanishing.system())
    ;
  }
  builder.run();
}
